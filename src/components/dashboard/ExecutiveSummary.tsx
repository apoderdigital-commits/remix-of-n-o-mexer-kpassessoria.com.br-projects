...
export function ExecutiveSummary({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-muted/95 via-card/90 to-background/90 backdrop-blur-sm p-4 sm:p-5 dark:from-card/80 dark:via-card/60 dark:to-background/60">
      {/* glow */}
      <div className="pointer-events-none absolute -top-24 -left-24 h-56 w-56 rounded-full bg-primary/30 blur-3xl dark:bg-primary/15" />
      <div className="pointer-events-none absolute -bottom-32 -right-24 h-64 w-64 rounded-full bg-fuchsia-500/25 blur-3xl dark:bg-fuchsia-500/10" />
