...
GRANT SELECT ON public.squad_weak_points TO authenticated;
GRANT ALL ON public.squad_weak_points TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.squad_goal_notes TO authenticated;
GRANT ALL ON public.squad_goal_notes TO service_role;
